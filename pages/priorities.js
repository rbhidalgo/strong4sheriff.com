                ...
                <div className={styles.cards}>
                    ...
                    <motion.div
                        ...
                        <div className={styles.textCol}>
                            <FadeInLeftWhenVisible>
                                ...
                                <p>With family members that have been incarcerated, Eric understands how important it is that we right size the footprint of a sprawling criminal justice system that often exacerbates recidivism, insecurity and homelessness.  As Sheriff, Eric will:</p>
                                <ul>
                    ...
                    <motion.div
                        ...
                        <div className={styles.textCol}>
                            <FadeInLeftWhenVisible>
                                <h2>Use of Force</h2>
                                <p>Jurisdictions with more restrictive use of force policies have fewer injuries to citizens and officers alike. When police unnecessarily and inappropriately use force we undermine trust in our community, and that makes everyone less safe.  As Sheriff, Eric will:</p>
                                <ul>
                    ...
                    <motion.div
                        ...
                        <div className={styles.textCol}>
                            <FadeInLeftWhenVisible>
                                ...
                                <ul>
                                  <li>Advocate for and work closely with modern violence reduction efforts rooted in data and science such as the use of gang intervention workers.</li>
                                  <li>Partner with communities and other law enforcement agencies to find solutions to neighborhood specific problems including vandalism and shoplifting.</li>   
                                  ...
                                  <li>Require deputies to undergo cultural competency training to ensure they are respectful to all victims of crime.</li>
                                  <li>Require deputies to undergo vulnerable victim training to ensure victims of elder abuse, fraud, sex assault, and domestic violence are treated with the utmost respect and dignity.</li>
                    ...
                    <motion.div
                        ...
                        <div className={styles.textCol + " " + styles.single}>
                            <FadeInLeftWhenVisible>
                                ...
                                <p>Respect is earned, it is not demanded. We must prove that the Los Angeles County Sheriff's Department deserves the community's trust by earning it, not demanding it. By letting the sunlight in, law enforcement can regain its stature as a respected profession, and we can better serve the needs of our community. As Sheriff, Eric will:</p>
                                <ul>
                                  ...
                                  <li>Increase and enhance relevant, meaningful, and effective trainings and tools to impact racial sensitivity, diversity awareness, and implicit bias awareness.</li>
